...
_If you want the absolute latest (and often incomplete) version of the lecture notes, you can download them by going to the [actions page](https://github.com/danielFHcode/calculus-1a/actions), clicking on the top link, and downloading the 'notes' artifact._
