...
+ #set enum(numbering: "(א)")
  ...
  + $
      & (n+k+1)/(4(n+k)^2 + 3) - (n+1)/(4n^2 + 3) \
      =& ((n+k+1)(4(n+k)^2 + 3) - (n+1)(4n^2 + 3))/((4n^2 + 3)(4(n+k)^2 + 3)) \
      =& ((n + k + 1 - n-1)(4n^2 + 3) + (n+k+1)(8n k + 4k^2))/(12n^2 + 9 + 4(n^2+k n)^2) \
      =& (k(4n^2 + 3) + (n+k+1)(8n k + 4k^2))/(12n^2 + 9 + 4(n^2+k n)^2) \
    $
