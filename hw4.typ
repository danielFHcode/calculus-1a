...
// )
// $a_n$
// מונוטונית עולה חלש, אז נגדיר את הסדרות
// $overline(a)_n = a_n + c/n, space underline(a)_n = a_n - c/n$
// לכל
// $n in NN$,
// מתקיים
// $a_n + c/n - a_n + c/n = (2c)/n --> 0$
// וגם
// $a_n - c/n <= a_(n+1) - c/(n+1) <= a_(n+1) + c/(n+1) <= a_n + c/n$
// לכל
// $n in NN$
// לכן מעקרון הרווחים המקוננים של קנטור קיים
// $a in RR$
// כך ש-$inter_(n in NN) [a_n - c/n, a_n + c/n] = a$.
// תהי
// $0 < epsilon$,
// אז כיוון ש-$c/n --> 0$
// קיים
...
// תהי
// $N < n in NN$,
// אז מתקיים ש-$[a_n-epsilon, a_n+epsilon] subset.neq [a_n-c/n, a_n+c/n] subset.eq {a}$,
// לכן
...
// $a_n --> a$,
// וכיוון ש-$a_n$
// תת סדרה של עצמה זה מוכיח את המשפט למקרה בו
// $a_n$
// מונוטונית עולה חלש.

// במקרה בו
// $a_n$
// לא מונוטונית עולה חלש, אבל קיים
// $N in NN$
// כך שלכל
// $N < n$
// מתקיים
// $a_n <= a_(n+1)$,
// אז מתקיים ש-$a_(n-N)$
// מונוטונית עולה חלש וגם חסומה ולכן מהמקרה הקודם היא מתכנסת, וכיוון ש-$a_(n-N)$
// תת סדרה של
// $a_n$,
// זה מוכיח את המשפט עבור מקרה זה.

// לבסוף, נותר המקרה בו לא קיים אף
// $N in NN$
// כך ש-$a_n <= a_(n+1)$
// לכל
// $N < n in NN$,
...
// $N < n in NN$
// כך ש-$a_(n+1) <= a_n$,
// אז מעקרון הסדר הטוב קיים
// $hat(n) = min{ N < n in NN | a_(n+1) <= a_n }$,
// ואז מתקיים
// $a_N < ... < a_(hat(n)-1) <= a_hat(n)$
